...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div className="relative group bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-primary/30 transition-all duration-300">
      ...
      <div className="p-6 space-y-4">
        <div>
          <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-[#3431dd] transition-colors duration-300">
            {title}
          </h3>
