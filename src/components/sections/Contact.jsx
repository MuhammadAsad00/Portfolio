        ...
        <FadeIn delay={0}>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-white/60 max-w-2xl mx-auto">
              Have a project in mind? Let's discus how we can bring your ideas
              to life.
            </p>
          </div>
        </FadeIn>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label
                    htmlFor="name"
                    className="black text-sm font-medium text-white/80 mb-2"
                  >
                    Name
                  </label>
                  <input
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-white/60 leading-relaxed">
                  ...
                  opportuntiies to be part of your vision. Feel free to reach
                  out!
                </p>
              </div>
              <div className="space-y-4">
                <div className="group relative bg-white/5 border border-white/10 rounded-2xl p-5 hover:border-primary/30 transition-all duration-300">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <a
                        ...
                        className="text-white hover:text-[#3431dd] transition-colors font-medium"
                      >
                        {PERSONAL_INFO.email}
                      </a>
                    </div>
