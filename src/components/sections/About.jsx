            ...
            <div className="flex flex-col gap-8">
              ...
              <FadeIn delay={200}>
                <div className="flex flex-col gap-4">
                  {PERSONAL_INFO.bio.map((pargraph, index) => (
                    <p
                      key={index}
              ...
              <div className="grid grid-cols-3 gap-8">
                {ABOUT_STATS.map((stat, index) => (
                  <div key={index} className="relative">
                    <div className="absolute -left-4 w-1 h-full bg-linear-to-b from-primary via-primary/50 to-primary/20 rounded-full"></div>
                    <div className="text-3xl font-normal mb-2 font-mono">
                      {stat.value}
                    </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="relative group">
                ...
                <div className="relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                  ...
                  <p className="text-sm text-white/70 leading-relaxed">
                    Writting maintainable, well-documented code that scales.
                  </p>
                </div>
              </div>
              <div className="relative group">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 w-full max-w-4xl">
              {skills.map((skill, index) => (
                ...
                >
                  ...
                  {/* Hover Glow Effect */}
                  <div className="absolute inset-0 bg-linear-to-br from-primary/0 to-primary/0 group-hover:from-primary/10 rounded-2xl transition-all duration-300"></div>
                </div>
              ))}
            </div>
          </div>
