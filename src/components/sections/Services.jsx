        ...
        <FadeIn delay={0}>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-white/60 max-w-xl mx-auto">
              Comrehensive solutions to transform your ideas into exceptional
              digital experiences.
            </p>
          </div>
        </FadeIn>
          ...
          {services.slice(0, 2).map((service, index) => {
            ...
            return (
              <FadeIn key={service.id} delay={100 + index * 100}>
                <div className="relative group bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-primary/30 transition-all duration-300 h-full min-h-70 flex flex-col">
                  <div className="mb-6">
          ...
          {services.slice(2).map((service, index) => {
            ...
            return (
              <FadeIn key={service.id} delay={300 + index * 100}>
                <div className="relative group bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                  <div className="mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-[#3431dd] transition-colors duration-300">
                      {service.title}
                    </h3>
